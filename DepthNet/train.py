...
from models.models import DepthNet as DepthNet
...
parser.add_argument('--lr', '--learning-rate', default=4e-5, type=float, metavar='LR', help='initial learning rate')
parser.add_argument('--geo', '--geo-cost', default=True, type=bool, metavar='GC', help='whether add geometry cost')
...
def main():
    ...
    depth_net = DepthNet(args.nlabel, args.mindepth, add_geo_cost=args.geo,
